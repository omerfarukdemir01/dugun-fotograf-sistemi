...
export default function AdminClient({ initialGalleries }: { initialGalleries: IGallery[] }) {
  ...
  // Başlangıç verisini sunucudan gelen prop ile başlatıyoruz
  const [galleries, setGalleries] = useState<IGallery[]>(initialGalleries);
