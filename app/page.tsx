          ...
          <div className="grid md:grid-cols-3 gap-12 md:gap-16">
            <div className="text-center group">
              <div className="relative w-full h-64 mb-6">
                <Image 
                  src="https://images.unsplash.com/photo-1591604466107-ec97de577aff?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8YnJpZGV8ZW58MHx8MHx8fDA%3D" 
                  alt="Düğün Belgeseli" 
                  fill 
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="md:col-span-2 relative aspect-[16/9]">
                <Image src="https://images.unsplash.com/photo-1515934751635-c81c6bc9a2d8?q=80&w=800&auto=format&fit=crop" alt="Portfolyo 1" fill sizes="(max-width: 768px) 100vw, 66vw" className="object-cover rounded-sm" />
              </div>
              <div className="relative aspect-[3/4]">
                <Image src="https://images.unsplash.com/photo-1520854221256-17451cc331bf?q=80&w=800&auto=format&fit=crop" alt="Portfolyo 2" fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover rounded-sm" />
              </div>
              <div className="relative aspect-square">
                <Image src="https://images.unsplash.com/photo-1607190074257-dd4b7af0309f?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8YnJpZGV8ZW58MHx8MHx8fDA%3D" alt="Portfolyo 3" fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover rounded-sm" />
              </div>
              <div className="relative aspect-square">
                <Image src="https://images.unsplash.com/photo-1550784718-990c6de52adf?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGJyaWRlfGVufDB8fDB8fHww" alt="Portfolyo 4" fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover rounded-sm" />
              </div>
              <div className="relative aspect-square">
                <Image src="https://images.unsplash.com/photo-1492175742197-ed20dc5a6bed?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fGJyaWRlfGVufDB8fDB8fHww" alt="Portfolyo 5" fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover rounded-sm" />
              </div>
            </div>
          </div>
        </section>
